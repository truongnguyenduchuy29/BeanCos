  ...
  const newsItems = [
    {
      ...
      excerpt: '1. DA CỦA CHÚNG TA CÓ CẤU TẠO NHƯ THẾ NÀO NHỈ ? Da gồm 3 lớp...',
      date: '12.07.2023',
    ...
    },
    {
      ...
      excerpt: '1.Treatment là gì ? Các bạn có thể đã google dịch từ "treatment" và ra kết quả...',
      date: '12.07.2023',
      image: 'https://images.pexels.com/photos/3762879/pexels-photo-3762879.jpeg?auto=compress&cs=tinysrgb&w=400',
      category: 'BHA',
    ...
    },
    {
      ...
      excerpt: 'Purging là hiện tượng xảy ra bình thường trên da khi lần đa có tác động...',
      date: '12.07.2023',
      image: 'https://images.pexels.com/photos/3762879/pexels-photo-3762879.jpeg?auto=compress&cs=tinysrgb&w=400',
                ...
                {item.category && (
                  <div className="absolute top-4 right-4">
                    <span className={`px-2 py-1 rounded text-xs font-bold ${
                      item.category === 'BHA' ? 'bg-red-500 text-white' :
                      item.category === 'LOTION' ? 'bg-blue-100 text-blue-800' :
                    ...
                    {item.tags.map((tag, index) => (
                      <span
                        ...
                        className={`px-2 py-1 rounded text-xs font-bold ${
                          tag === 'PURGING' ? 'bg-green-600 text-white' :
                          tag === 'BREAK OUT' ? 'bg-red-600 text-white' :
